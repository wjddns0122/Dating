...
abstract class $LikeCopyWith<$Res> {
  ...
  @useResult
  $Res call({int like, String name, int age});
}
...
class _$LikeImpl implements _Like {
  _$LikeImpl({required this.like, required this.name, required this.age});
  ...
  @override
  String toString() {
    return 'Like(like: $like, name: $name, age: $age)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, like, name, age);
...
abstract class _Like implements Like {
  factory _Like(
      ...
      required final int age}) = _$LikeImpl;
